#Common headers
common_includes := device/lge/v4xx-common/display/libgralloc
common_includes += device/lge/v4xx-common/display/liboverlay
common_includes += device/lge/v4xx-common/display/libcopybit
common_includes += device/lge/v4xx-common/display/libqdutils
common_includes += device/lge/v4xx-common/display/libhwcomposer
